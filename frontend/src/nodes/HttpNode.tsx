...
export default function HttpNode({ id, data }: any) {
  ...
  useEffect(() => {
    console.log("✅ HttpNode mounted for id=", id);
  }, [id]);
        ...
        <div className="modal-overlay">
          <div className="modal">
            ...
            <textarea
              ...
              rows={6}
              style={{ width: "100%" }}
              placeholder='e.g. curl "https://api.example.com" -X POST -H "Content-Type: application/json" -d "{\"foo\":\"bar\"}"'
            />
